...
<div id="contentWrapper">
	...
	<main id="mainContent">
		<div id="contentMenu">
			<h2 id="titleVideosLink">Laughter is free! <img src="./assets/images/uploadForm/bigSmile2.png" alt="Big Smile" align="middle" /></h2>
		...
		<?php 
			...
			$countAllMP4 = file("./users/gallery.txt");
		...
		<li class="pgCounter"><a href="?page=images&pg=1">&lt;&lt;&lt;</a></li>
		<li class="pgCounter"><a href="?page=images&pg=<?php if ($pageNum > 1) { echo --$pageNum; } else { echo $pageNum; } ?>">&lt;</a></li>
		<?php 
			// the paging loop:
			for ($count = 1; $count <= $neededCount; $count+=10) {
				if (($count + 9) > $neededCount) {
					echo "<li class='pgCounter'><a href='?page=images&pg=" . ceil($count/10) . "'>" . $count . " - " . $neededCount . "</a></li>";
				} else {
					echo "<li class='pgCounter'><a href='?page=images&pg=" . ceil($count/10) . "'>" . $count . " - " . ($count+9) . "</a></li>";
				}
			}
		?>
		<li class="pgCounter"><a href="?page=images&pg=<?php if ($pageNum == $numberOfPages) { echo $pageNum; } else { echo ++$pageNum; } ?>" >&gt;</a></li>
		<li class="pgCounter"><a href="?page=images&pg=<?php echo $numberOfPages; ?>">&gt;&gt;&gt;</a></li>
		</ul>
	</main>
